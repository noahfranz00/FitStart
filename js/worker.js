// Blueprint — Cloudflare Worker (Multi-File Server)
const FILES = {
...
<title>Blueprint — AI-Powered Fitness</title>
...
(function() {
  try {
    ...
    ctx.shadowColor = '#D4A520'; ctx.shadowBlur = 20;
    // Left plate
    ...
    const manifest = {
      ...
      description: 'AI-powered fitness plans and workout tracking',
      start_url: './',
      display: 'standalone',
...
<nav>
  <div class="logo"><img class="logo-icon" src="data:image/jpeg;base64," alt="Blueprint"><span class="logo-text">BLUEPRINT</span></div>
  <div class="nav-right">
...
<div class="shell">
  <div class="sidebar-nav">
    ...
    <button class="sb-btn" onclick="dashNav('nutrition',this)"><span class="sb-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="15" height="15"><path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2"/><path d="M7 2v20"/><path d="M21 15V2v0a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3Zm0 0v7"/></svg></span>Nutrition</button>
      ...
      <div class="prog-card" style="margin-bottom:14px">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px">
          ...
          <div style="display:flex;align-items:center;gap:8px">
            ...
            <button onclick="logBodyWeight()" style="padding:8px 14px;background:linear-gradient(135deg,#B8900B,#D4A520,#F0D060,#D4A520,#B8900B);border:none;border-radius:8px;color:var(--black);font-family:'Bebas Neue',sans-serif;font-size:0.85rem;letter-spacing:1px;cursor:pointer">LOG</button>
          </div>
        </div>
      ...
      <div style="display:flex;flex-direction:column;gap:14px;max-width:680px">
        ...
        <div class="card" style="border-color:rgba(251,146,60,0.2)">
          ...
          <div style="display:flex;justify-content:space-between;align-items:center">
            <div><div style="font-size:0.95rem;font-weight:600;margin-bottom:3px">Blueprint Pro &nbsp;<span style="color:var(--orange);font-size:0.75rem;font-weight:700">● ACTIVE</span></div><div style="font-family:'DM Mono',monospace;font-size:0.72rem;color:var(--dim)">$29.99/month · Cancel anytime</div></div>
        ...
        <button id="save-btn" onclick="saveSettings()" style="padding:14px;background:var(--gold);color:var(--black);border:none;border-radius:12px;font-family:'Bebas Neue',sans-serif;font-size:1.1rem;letter-spacing:2px;cursor:pointer">SAVE CHANGES</button>
      </div>
    </div>
        ...
        <div id="coach-messages" class="coach-messages">
          <div id="coach-starters" class="coach-starters">
            <div class="coach-welcome">
              <div class="coach-welcome-icon"><svg viewBox="0 0 24 24" fill="none" stroke="var(--gold)" stroke-width="1.5" width="32" height="32"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg></div>
...
<div id="unplanned-modal" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,0.92);z-index:6000;align-items:flex-end;justify-content:center">
  <div id="unplanned-modal-inner" style="background:var(--dark);border:1px solid var(--border2);border-radius:24px 24px 0 0;width:100%;max-width:600px;padding:24px 20px 40px;max-height:92dvh;overflow-y:auto;transition:max-height 0.3s ease">
    ...
    <div id="ai-workout-preview" style="display:none">
      ...
      <button onclick="launchAIWorkout()" style="width:100%;padding:16px;background:linear-gradient(135deg,#B8900B,#D4A520,#F0D060,#D4A520,#B8900B);border:none;border-radius:12px;color:var(--black);font-family:'Bebas Neue',sans-serif;font-size:1.15rem;letter-spacing:2px;cursor:pointer">BEGIN WORKOUT →</button>
...
<div id="barcode-modal" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,0.95);z-index:9999;flex-direction:column">
  ...
  <div style="padding:20px;border-bottom:1px solid var(--border)">
    ...
    <div style="display:flex;gap:10px">
      ...
      <button onclick="submitBarcode()"
        style="padding:14px 24px;background:linear-gradient(135deg,#B8900B,#D4A520,#F0D060,#D4A520,#B8900B);border:none;border-radius:10px;color:var(--black);font-family:'Bebas Neue',sans-serif;font-size:1rem;letter-spacing:1.5px;cursor:pointer;font-weight:700;white-space:nowrap">LOOK UP</button>
    </div>
  ...
  <div style="flex:1;position:relative;overflow:hidden;background:#000">
    ...
    <div style="position:absolute;inset:0;display:flex;align-items:center;justify-content:center;pointer-events:none">
      <div style="width:260px;height:140px;border:2px solid var(--gold);border-radius:10px;box-shadow:0 0 0 9999px rgba(0,0,0,0.55)"></div>
    </div>
...
<div class="add-ex-modal" id="dash-ex-picker-modal">
  <div class="add-ex-sheet">
    ...
    <div id="aes-build-tray" style="display:none;border-top:1px solid var(--border);padding:14px 16px;background:var(--dark)">
      ...
      <button onclick="beginCustomWorkoutFromPicker()" id="aes-begin-btn" style="display:none;width:100%;padding:13px;background:linear-gradient(135deg,#B8900B,#D4A520,#F0D060,#D4A520,#B8900B);border:none;border-radius:10px;color:var(--black);font-family:'Bebas Neue',sans-serif;font-size:1rem;letter-spacing:2px;cursor:pointer">BEGIN WORKOUT →</button>
    </div>
    ...
    <div id="aes-config-overlay" style="display:none;position:absolute;inset:0;background:rgba(0,0,0,0.92);border-radius:inherit;z-index:10;flex-direction:column;align-items:center;justify-content:center;padding:28px 24px">
      <div style="width:100%;max-width:320px">
        ...
        <div style="display:flex;gap:10px">
          ...
          <button onclick="confirmAesConfig()" style="flex:2;padding:13px;background:linear-gradient(135deg,#B8900B,#D4A520,#F0D060,#D4A520,#B8900B);border:none;border-radius:10px;color:var(--black);font-family:'Bebas Neue',sans-serif;font-size:1rem;letter-spacing:2px;cursor:pointer">ADD TO WORKOUT</button>
        </div>
      </div>
    </div>
  </div>
...
<div id="setrepedit-modal" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,0.82);z-index:9500;align-items:center;justify-content:center;padding:20px" onclick="if(event.target===this)closeSetRepEditor()">
  <div style="background:var(--card);border:1px solid var(--border);border-radius:18px;padding:24px 22px;width:100%;max-width:340px" onclick="event.stopPropagation()">
    ...
    <button onclick="applySetRepEdit()" style="width:100%;padding:13px;background:linear-gradient(135deg,#B8900B,#D4A520,#F0D060,#D4A520,#B8900B);border:none;border-radius:10px;color:var(--black);font-family:'Bebas Neue',sans-serif;font-size:1rem;letter-spacing:2px;cursor:pointer">APPLY</button>
  </div>
</div>
...
` },
  "/styles.css": { type: "text/css; charset=utf-8", body: `*, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; min-width:0; }
:root {
...
.logo { font-family:'Bebas Neue',sans-serif; font-size:1.9rem; letter-spacing:2px; display:flex; align-items:center; gap:10px; color:#C8A23D; }
.logo-text { background:linear-gradient(135deg,#B8900B,#D4A520,#F0D060,#D4A520,#B8900B); -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text; }
.logo-icon { width:34px; height:34px; border-radius:6px; object-fit:contain; flex-shrink:0; }
...
.nav-cta { padding:9px 22px; border-radius:10px; border:none; background:linear-gradient(135deg,#B8900B,#D4A520,#F0D060,#D4A520,#B8900B); color:var(--black); font-family:'Bebas Neue',sans-serif; font-size:0.95rem; letter-spacing:1.5px; cursor:pointer; transition:all 0.2s; font-weight:700; }
...
.avatar { width:26px; height:26px; border-radius:50%; background:linear-gradient(135deg,#B8900B,#D4A520,#F0D060,#D4A520,#B8900B); display:flex; align-items:center; justify-content:center; font-size:0.65rem; font-weight:700; color:var(--black); flex-shrink:0; }
...
.line-accent { background:linear-gradient(135deg,#B8900B,#D4A520,#F0D060,#D4A520,#B8900B); -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text; transition:color 0.4s; display:block; }
...
.tier-badge { font-size:0.65rem; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; color:var(--gold); background:var(--gold-dim); border:1px solid rgba(212,165,32,0.2); padding:5px 12px; border-radius:6px; }
...
.btn-generate { width:100%; margin-top:24px; padding:16px; background:linear-gradient(135deg,#B8900B,#D4A520,#F0D060,#D4A520,#B8900B); color:var(--black); border:none; border-radius:12px; font-family:'Bebas Neue',sans-serif; font-size:1.1rem; letter-spacing:2px; cursor:pointer; transition:all 0.2s; font-weight:700; }
...
.results-tier-badge { font-family:'Bebas Neue',sans-serif; font-size:0.95rem; letter-spacing:2px; padding:8px 16px; border-radius:8px; background:var(--gold-dim); color:var(--gold); border:1px solid rgba(212,165,32,0.2); }
...
.day-tag.workout { background:var(--gold-dim); color:var(--gold); }
.day-tag.workout.intermediate { background:var(--gold-dim); color:var(--gold); }
.day-tag.workout.advanced { background:var(--gold-dim); color:var(--gold); }
...
.btn-enter-app { display:inline-flex; align-items:center; gap:10px; padding:18px 44px; border-radius:12px; border:none; background:linear-gradient(135deg,#B8900B,#D4A520,#F0D060,#D4A520,#B8900B); color:var(--black); font-family:'Bebas Neue',sans-serif; font-size:1.2rem; letter-spacing:2px; cursor:pointer; transition:all 0.2s; font-weight:700; }
...
.included-check { width:18px; height:18px; border-radius:5px; background:var(--gold-dim); border:1px solid rgba(212,165,32,0.25); display:flex; align-items:center; justify-content:center; font-size:0.6rem; color:var(--gold); flex-shrink:0; }
.signup-card { background:var(--card); border:1px solid var(--border2); border-radius:22px; padding:32px; position:sticky; top:90px; }
.trial-badge { display:flex; align-items:center; justify-content:center; gap:8px; background:var(--gold-dim); border:1px solid rgba(212,165,32,0.2); border-radius:10px; padding:12px; margin-bottom:24px; font-size:0.8rem; font-weight:700; color:var(--gold); }
...
.tb-val.free { color:var(--gold); font-family:'Bebas Neue',sans-serif; font-size:1rem; letter-spacing:1px; }
.tb-val.after { color:var(--off); font-size:0.75rem; }
.btn-start-trial { width:100%; padding:17px; background:linear-gradient(135deg,#B8900B,#D4A520,#F0D060,#D4A520,#B8900B); color:var(--black); border:none; border-radius:13px; font-family:'Bebas Neue',sans-serif; font-size:1.2rem; letter-spacing:2px; cursor:pointer; transition:all 0.2s; display:flex; align-items:center; justify-content:center; gap:8px; font-weight:700; }
...
body.intermediate .btn-start-trial { background:linear-gradient(135deg,#B8900B,#D4A520,#F0D060,#D4A520,#B8900B); }
body.advanced .btn-start-trial { background:linear-gradient(135deg,#B8900B,#D4A520,#F0D060,#D4A520,#B8900B); }
...
.sb-btn.active { background:var(--gold-dim); color:var(--gold); border:1px solid rgba(212,165,32,0.15); }
...
.sb-btn.active .sb-badge { background:rgba(212,165,32,0.15); color:var(--gold); }
...
.today-grid { display:grid; grid-template-columns:repeat(4, 1fr); gap:10px; margin-bottom:16px; }
.stat-card { background:var(--card); border:1px solid var(--border); border-radius:16px; padding:16px; }
.sc-val { font-family:'Bebas Neue',sans-serif; font-size:1.8rem; letter-spacing:1px; background:linear-gradient(135deg,#B8900B,#D4A520,#F0D060,#D4A520,#B8900B); -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text; line-height:1; margin-bottom:3px; }
.sc-val.over { background:#F43F5E; -webkit-background-clip:text; -webkit-text-fill-color:transparent; background-clip:text; }
.sc-val.over + .sc-sub { color:var(--red); }
.sc-sub { font-family:'DM Mono',monospace; font-size:0.75rem; color:var(--off); }
.prog-bar { height:3px; background:rgba(255,255,255,0.06); border-radius:2px; margin-top:10px; }
.prog-fill { height:100%; border-radius:2px; background:linear-gradient(90deg,#B8900B,#D4A520,#F0D060,#D4A520,#B8900B); transition:width 0.4s ease; }
...
.wc-badge { display:inline-flex; align-items:center; gap:6px; font-size:0.65rem; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; color:var(--gold); background:var(--gold-dim); border:1px solid rgba(212,165,32,0.2); padding:4px 10px; border-radius:6px; margin-bottom:6px; width:fit-content; }
.wc-name { font-family:'Bebas Neue',sans-serif; font-size:1.4rem; letter-spacing:1px; }
.btn-primary { padding:11px 24px; background:linear-gradient(135deg,#B8900B,#D4A520,#F0D060,#D4A520,#B8900B); color:var(--black); border:none; border-radius:10px; font-family:'Bebas Neue',sans-serif; font-size:0.95rem; letter-spacing:2px; cursor:pointer; transition:all 0.2s; flex-shrink:0; font-weight:700; }
.btn-primary:hover { opacity:0.9; transform:translateY(-1px); }
.btn-primary.done { background:var(--gold-dim); color:var(--gold); border:1px solid rgba(212,165,32,0.3); }
...
.ex-row.done { border-color:rgba(212,165,32,0.2); background:rgba(212,165,32,0.04); }
...
.log-toggle-title { display:flex; align-items:center; gap:10px; font-size:0.85rem; font-weight:700; color:var(--gold); }
.plus-icon { width:26px; height:26px; border-radius:7px; background:var(--gold-dim); border:1px solid rgba(212,165,32,0.25); display:flex; align-items:center; justify-content:center; font-size:1rem; color:var(--gold); }
...
.lf-label.cal { color:var(--off); } .lf-label.p { color:var(--gold); } .lf-label.c { color:var(--blue); } .lf-label.f { color:var(--orange); }
...
.wday:hover { border-color:var(--gold); transform:translateY(-2px); }
.wday.is-today { border-color:var(--gold); background:var(--gold-dim); }
.wday.is-done { border-color:rgba(212,165,32,0.25); }
...
.wday.is-today .wday-name { color:var(--gold); }
...
.dp-btn.active { border-color:var(--gold); background:var(--gold-dim); color:var(--gold); }
...
.mb-val { font-family:'Bebas Neue',sans-serif; font-size:2rem; letter-spacing:1px; color:var(--gold); line-height:1; transition:color 0.3s; }
...
.mb-fill { height:100%; border-radius:2px; background:linear-gradient(90deg,#B8900B,#D4A520,#F0D060,#D4A520,#B8900B); transition:width 0.4s ease, background 0.3s; }
...
.mr-macros .mp { color:var(--gold); } .mr-macros .mc { color:var(--blue); } .mr-macros .mf { color:var(--orange); }
...
.wo-back:hover { color:var(--gold); border-color:var(--gold); }
...
.wo-ex-item.active { border-color:var(--gold); background:var(--gold-dim); }
.wo-ex-item.completed { border-color:rgba(212,165,32,0.2); background:rgba(212,165,32,0.04); }
.wo-ex-num { font-family:'DM Mono',monospace; font-size:0.65rem; color:var(--dim); margin-bottom:4px; }
.wo-ex-item.active .wo-ex-num { color:var(--gold); }
...
.strength-score { display:flex; align-items:center; gap:12px; padding:10px 14px; background:linear-gradient(135deg,rgba(212,165,32,0.08),rgba(212,165,32,0.04)); border:1px solid rgba(212,165,32,0.2); border-radius:10px; margin-bottom:12px; font-family:'DM Mono',monospace; }
.strength-score-val { font-size:1.4rem; font-weight:600; color:var(--gold); letter-spacing:1px; }
...
.strength-score-delta { font-size:0.8rem; color:var(--gold); margin-left:auto; }
...
.ex-video-badge { font-size:0.7rem; font-weight:700; letter-spacing:1px; text-transform:uppercase; color:var(--gold); background:var(--gold-dim); border:1px solid rgba(212,165,32,0.3); padding:8px 14px; border-radius:10px; cursor:pointer; transition:all 0.15s; user-select:none; display:flex; flex-direction:column; gap:2px; min-width:110px; position:relative; }
.ex-video-badge:hover { background:rgba(212,165,32,0.15); border-color:rgba(212,165,32,0.5); transform:scale(1.02); }
...
.demo-frame:nth-child(2) .demo-frame-label { color:var(--gold); }
...
.btn-add-ex { display:flex; align-items:center; gap:6px; padding:9px 16px; background:var(--gold-dim); border:1px solid rgba(212,165,32,0.25); border-radius:9px; color:var(--gold); font-family:'Bebas Neue',sans-serif; font-size:0.9rem; letter-spacing:1.5px; cursor:pointer; transition:all 0.2s; }
.btn-add-ex:hover { background:rgba(212,165,32,0.2); }
...
.aes-search input:focus { border-color:var(--gold); }
...
.aes-filter-btn.active { border-color:var(--gold); background:var(--gold-dim); color:var(--gold); }
...
.aes-dropdown-item.selected { color:var(--gold); }
...
.aes-item:hover { border-color:var(--gold); }
.aes-item.added { border-color:rgba(212,165,32,0.3); background:rgba(212,165,32,0.05); }
...
.rest-countdown { font-family:'Bebas Neue',sans-serif; font-size:6rem; letter-spacing:2px; color:var(--gold); line-height:1; margin-bottom:8px; }
...
.btn-skip-rest:hover { border-color:var(--gold); color:var(--gold); }
...
.wo-ex-sidebar-item.active { background:var(--gold-dim); border-color:rgba(212,165,32,0.2); }
.wo-ex-sidebar-num { font-family:'DM Mono',monospace; font-size:0.68rem; color:var(--dim); width:18px; flex-shrink:0; }
.wo-ex-sidebar-item.active .wo-ex-sidebar-num { color:var(--gold); }
...
.set-weight-input:focus { border-color:var(--gold); }
...
.btn-cat-add { display:flex; align-items:center; gap:5px; padding:7px 13px; background:linear-gradient(135deg,#B8900B,#D4A520,#F0D060,#D4A520,#B8900B); border:none; border-radius:8px; color:#111; font-family:'Bebas Neue',sans-serif; font-size:0.78rem; letter-spacing:1px; cursor:pointer; white-space:nowrap; transition:all 0.2s; font-weight:700; }
.btn-cat-add:hover { opacity:0.85; }
...
.mer-cal { font-family:'Bebas Neue',sans-serif; font-size:0.95rem; color:var(--gold); }
...
.food-modal-input:focus { border-color:var(--gold); }
.food-modal-input::placeholder { color:var(--dim); }
.btn-food-modal-search { padding:10px 16px; background:var(--gold-dim); border:1px solid rgba(212,165,32,0.25); border-radius:10px; color:var(--gold); font-family:'Bebas Neue',sans-serif; font-size:0.88rem; letter-spacing:1.5px; cursor:pointer; white-space:nowrap; }
...
.fmt-tab.active { color:var(--gold); border-bottom-color:var(--gold); }
...
.btn-food-search { padding:10px 18px; background:var(--gold-dim); border:1px solid rgba(212,165,32,0.25); border-radius:10px; color:var(--gold); font-family:'Bebas Neue',sans-serif; font-size:0.9rem; letter-spacing:1.5px; cursor:pointer; white-space:nowrap; transition:all 0.2s; }
.btn-food-search:hover { background:rgba(212,165,32,0.2); }
...
.fri-cal { font-family:'Bebas Neue',sans-serif; font-size:1rem; color:var(--gold); white-space:nowrap; }
.btn-log-food { padding:7px 12px; background:var(--gold-dim); border:1px solid rgba(212,165,32,0.2); border-radius:8px; color:var(--gold); font-family:'Bebas Neue',sans-serif; font-size:0.8rem; letter-spacing:1px; cursor:pointer; white-space:nowrap; }
.btn-log-food:hover { background:rgba(212,165,32,0.2); }
...
.coach-bubble.user { align-self:flex-end; background:linear-gradient(135deg,#B8900B,#D4A520,#F0D060,#D4A520,#B8900B); color:#0a0a0a; border-bottom-right-radius:4px; font-weight:600; }
...
.coach-send-btn { width:40px; height:40px; border-radius:50%; border:none; background:linear-gradient(135deg,#B8900B,#D4A520,#F0D060,#D4A520,#B8900B); color:var(--black); cursor:pointer; display:flex; align-items:center; justify-content:center; transition:opacity 0.2s; flex-shrink:0; }
...
` },
  "/js/app.js": { type: "text/javascript; charset=utf-8", body: `// ═══════════════════════════════════════════
// APP.JS — Main App Initialization, Exercise DB,
//   State Management, Onboarding, Signup, Storage, API
// ═══════════════════════════════════════════
...
` },
  "/scoring.js": { type: "text/javascript; charset=utf-8", body: `// ═══════════════════════════════════════════
...
function _showWorkoutSummary(workoutName, prs, durationMs, setsData, exercises) {
  ...
  var deltaColor = pct >= 0 ? '#D4A520' : '#f87171';
  ...
  overlay.innerHTML =
    ...
    '<div id="wo-share-card" style="background:#111;border:1px solid rgba(212,165,32,0.4);border-radius:24px;padding:30px 24px 22px;position:relative;overflow:hidden">' +
      '<div style="position:absolute;top:-40px;right:-40px;width:140px;height:140px;background:radial-gradient(circle,rgba(212,165,32,0.15) 0%,transparent 70%);pointer-events:none"></div>' +
      '<div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:24px">' +
        '<div>' +
          '<div style="font-family:\\'Bebas Neue\\',sans-serif;font-size:1rem;letter-spacing:3px;color:#ddd">' + dateStr + '</div>' +
      ...
      '<div style="display:flex;align-items:center;gap:20px;margin-bottom:22px;padding:20px;background:#1a1a1a;border-radius:16px;border:1px solid #333">' +
        ...
        '<div style="flex:1">' +
          ...
          '<div style="font-family:\\'Bebas Neue\\',sans-serif;font-size:2.8rem;color:#fff;line-height:1">' + score + '<span style="font-size:1.1rem;color:#bbb">/1000</span></div>' +
          (deltaText ? '<div style="font-size:1.05rem;font-weight:700;color:' + deltaColor + '">' + deltaText + ' vs last</div>' : '') +
        '</div>' +
      '</div>' +
      '<div style="display:grid;grid-template-columns:repeat(' + Math.min(displayStats.length, 4) + ',1fr);gap:1px;background:#333;border-radius:14px;overflow:hidden;margin-bottom:20px">' +
        displayStats.map(function(s) {
          var unitSpan = s.unit ? '<span style="font-size:1rem;color:#ccc;margin-left:2px;text-transform:uppercase">' + s.unit + '</span>' : '';
          return '<div style="background:#1a1a1a;padding:18px 8px;text-align:center">' +
            '<div style="font-family:\\'Bebas Neue\\',sans-serif;font-size:2rem;color:#fff;line-height:1">' + s.value + unitSpan + '</div>' +
            '<div style="font-size:0.8rem;font-weight:700;letter-spacing:1.5px;color:#bbb;margin-top:6px">' + s.label + '</div>' +
          '</div>';
        }).join('') +
      '</div>' +
    ...
    img.onload = function() {
      ...
      canvas.toBlob(function(blob) {
        if (navigator.share && navigator.canShare && navigator.canShare({ files: [new File([blob], 'workout.png', { type: 'image/png' })] })) {
          navigator.share({
            files: [new File([blob], 'Blueprint-Workout.png', { type: 'image/png' })],
            title: 'My Blueprint Workout',
            text: 'Just crushed a workout on Blueprint 💪'
          }).catch(function() {});
        } else {
          // Fallback: download
          var a = document.createElement('a');
          a.href = URL.createObjectURL(blob);
          a.download = 'Blueprint-Workout.png';
          a.click();
...
function _fallbackShareText(card) {
  ...
  if (navigator.share) {
    navigator.share({ title: 'My Blueprint Workout', text: text }).catch(function() {});
...
` },
  "/js/scoring.js": { type: "text/javascript; charset=utf-8", body: `// ═══════════════════════════════════════════
// SCORING.JS — Strength Score (0-1000) Math
// ═══════════════════════════════════════════
// Dependencies: woWorkout, woSets, USER, todayDateStr(), getExLogs()
// Exposes: _computeWorkoutStrengthScore(), _showWorkoutSummary()
...
` },
  "/logger.js": { type: "text/javascript; charset=utf-8", body: `// ═══════════════════════════════════════════
...
` },
  "/js/logger.js": { type: "text/javascript; charset=utf-8", body: `// ═══════════════════════════════════════════
// LOGGER.JS — Dashboard UI, Workout Environment, 
//   Nutrition/Food Tracking, Progress, Exercise Modals
// ═══════════════════════════════════════════
// Dependencies: All globals from app.js, scoring.js functions
...
` },
  "/coach.js": { type: "text/javascript; charset=utf-8", body: `// ═══════════════════════════════════════════
...
` },
  "/js/coach.js": { type: "text/javascript; charset=utf-8", body: `// ═══════════════════════════════════════════
// COACH.JS — AI Coach Chat & Food Logging via Coach
// ═══════════════════════════════════════════
// Dependencies: USER, TARGETS, GYM_DAYS, DAY_WORKOUTS, CURRENT_WEEK,
//   callClaude(), getMealCatEntries(), saveToStorage(), renderMealCategories(),
